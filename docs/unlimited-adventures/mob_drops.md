...
:::warning[주의]
옮긴이가 최신버전의 정보에 미숙하므로 몬스터 번역이 올바르지 않을 수 있습니다.\
옳지 않은 변역이 있을 시 디스코드(아이디 : dead_kim)으로 문의 부탁드립니다.\
또한 아래 전리품들은 마인크래프트에 존재하지 않은 Unlimited Adventures 전용 아이템 이므로 서버팩을 수정하실 분들의 원할한 작업을 위해 번역되지 않았습니다.(절떄 귀찮아서 그런거 아님. 아무튼 아님.)
:::
